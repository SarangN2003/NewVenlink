...
#ENV PATH="/usr/local/bin:$PATH"
#
## Install required dependencies including WeasyPrint system requirements
#RUN apt-get update && apt-get install -y \
#    wget \
#    unzip \
#    curl \
...
## Install Python dependencies
#RUN pip install --no-cache-dir -r requirements.txt
#RUN pip install --no-cache-dir pytest pytest-html boto3
#
## Set correct permissions for ChromeDriver
#RUN chmod +x /usr/bin/chromedriver
#
...
#        echo 'Removing HTML report...'; \
#        rm /test_NewLogin/reports/report.html; \
#        echo 'Uploading PDF report to S3...'; \
#        aws s3 cp /test_NewLogin/reports/report.pdf s3://venlinkfargatereport/reports/report.pdf --region $AWS_DEFAULT_REGION; \
#    else \
#        echo 'HTML report not found, PDF conversion skipped!'; \
#    fi; \
#    echo 'Test execution completed. Keeping container alive...'; \
#    tail -f /dev/null"]


###Report.pdf link in email
